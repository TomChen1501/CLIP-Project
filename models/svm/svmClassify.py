...
class CLIPAttributeSVM:
    ...
    def train_and_evaluate(self, positive_tensor, negative_tensor, sample_ratio=0.1):
        ...
        accuracy, f1 = self.evaluate(X_test, y_test)
        # print("Accuracy:", accuracy)
        # print(report)
        # return accuracy, report
        return accuracy, f1
    
    def save_model(self, path=f"models/trained_models/svm_model.pkl"):
        joblib.dump(self.model, path)
        print(f"Model saved to {path}")

    def load_model(self, path=f"models/trained_models/svm_model.pkl"):
...
if __name__ == "__main__":
    ...
    svm.save_model(path="models/trained_models/svm_smile_model.pkl")
